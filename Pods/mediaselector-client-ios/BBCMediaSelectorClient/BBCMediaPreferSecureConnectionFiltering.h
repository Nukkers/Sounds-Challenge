//
//  BBCMediaPreferSecureConnectionFiltering.h
...
NS_SWIFT_NAME(MediaPreferSecureConnectionFiltering)
@interface BBCMediaPreferSecureConnectionFiltering : NSObject <BBCMediaConnectionFiltering>
