//
//  BBCMediaEnforceNonSecureConnectionFiltering.h
...
NS_SWIFT_NAME(MediaEnforceNonSecureConnectionFiltering)
@interface BBCMediaEnforceNonSecureConnectionFiltering : NSObject <BBCMediaConnectionFiltering>
