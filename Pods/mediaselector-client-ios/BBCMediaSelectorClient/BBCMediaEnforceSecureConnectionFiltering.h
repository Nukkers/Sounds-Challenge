//
//  BBCMediaEnforceSecureConnectionFiltering.h
...
NS_SWIFT_NAME(MediaEnforceSecureConnectionFiltering)
@interface BBCMediaEnforceSecureConnectionFiltering : NSObject <BBCMediaConnectionFiltering>
